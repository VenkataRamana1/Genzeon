					...
					<li>
						<p>
							...
							<input type="text" name="lastName" class="input-text"
								value="${lastName}" placeholder="Please enter your last name" />
						</p>
						<p class="pull-right">
